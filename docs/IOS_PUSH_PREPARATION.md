...
1. Enable **Push Notifications** for the ZPatrol App ID in Apple Developer.
2. Create an APNs Auth Key (`.p8`) or configure the appropriate APNs certificate.
3. Upload the APNs key/certificate to the ZPatrol iOS app in Firebase Console.
